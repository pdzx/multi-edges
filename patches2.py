...
class FancyArrowPatch(Patch):
        ...
        *shrinkA* and *shrinkB*. An arrow is drawn along this
        ...
        if posA is not None and posB is not None and path is None:
            ...
            if connectionstyle is None:
                connectionstyle = "arc3"
            self.set_connectionstyle(connectionstyle,rad)
    ...
    def set_connectionstyle(self, connectionstyle,rad, **kw):
        """
        ...
        if (isinstance(connectionstyle, ConnectionStyle._Base) or
            ...
            if rad==None:
                rad=0
            self._connector = ConnectionStyle(connectionstyle,rad=rad, **kw)
        self.stale = True
